            ...
            for item in self.msginfocontainer:
                ...
                if item.recomm_for:
                    ...
                    if rcp_result:
                        ...
                        logger.info("Messages collected generate:{}  and approver_applier:{}".format(rcp_result['generator']['payload'].keys(),rcp_result['applier_approver']['payload'].keys()))
                    else:
                    ...
                    if rcnp_result:
                        logger.info ("Poller succesfully Finished processing using {} {} has returned {}".format (self.recommendPolicyNotPresent,item,rcnp_result))
